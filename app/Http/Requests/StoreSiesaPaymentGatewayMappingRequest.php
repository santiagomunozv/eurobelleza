...
class StoreSiesaPaymentGatewayMappingRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'payment_gateway_name' => ['required', 'string', 'max:100', 'unique:siesa_payment_gateway_mappings,payment_gateway_name'],
